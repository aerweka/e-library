...
<div class="card card-primary">
		...
		<table id="dataTable" class="table table-bordered table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a style="color:rgb(44, 47, 51);" aria-hidden="true" id="delete" href="/buku/editBuku/<?php echo e($data->no_isbn); ?>">Pinjam</a>
					</td>
				</tr>
	...
	<?php $__env->stopSection(); ?>
<?php echo $__env->make('user/layout/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web_laraboots\resources\views/user/pageBuku.blade.php ENDPATH**/ ?>