...
<aside class="main-sidebar sidebar-light-primary elevation-4">
  ...
  <a href="#" class="brand-link">
    <img src="{{ asset('asset/image/bmth.jpg') }}" class="brand-image img-circle elevation-3" style="opacity: .8">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="{{ URL::asset('/asset/image/yorichi.jfif') }}" class="img-circle elevation-8" alt="User Image">
      </div>
      <div class="info">
